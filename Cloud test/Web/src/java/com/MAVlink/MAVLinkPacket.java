    ...
    */
    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_set_wifi_ap_enabled.MAVLINK_MSG_ID_SET_WIFI_AP_ENABLED:
                return  new msg_set_wifi_ap_enabled(this);
                 
            case msg_set_wifi_ap_disabled.MAVLINK_MSG_ID_SET_WIFI_AP_DISABLED:
                return  new msg_set_wifi_ap_disabled(this);
                 
            case msg_get_wifi_status.MAVLINK_MSG_ID_GET_WIFI_STATUS:
                return  new msg_get_wifi_status(this);
                 
            case msg_wifi_status.MAVLINK_MSG_ID_WIFI_STATUS:
                return  new msg_wifi_status(this);
                 
            case msg_get_network_stats.MAVLINK_MSG_ID_GET_NETWORK_STATS:
                return  new msg_get_network_stats(this);
                 
            case msg_land_command.MAVLINK_MSG_ID_LAND_COMMAND:
                return  new msg_land_command(this);
                 
            case msg_liftoff_command.MAVLINK_MSG_ID_LIFTOFF_COMMAND:
                return  new msg_liftoff_command(this);
